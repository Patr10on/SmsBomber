...
import threading
import webbrowser
webbrowser.open("https://www.instagram.com/by_.ram?igsh=b3hrM2kxNDRrOGpr") 
...
|_|                   |_|    |_|  \_\       
 ...
 /_ |    / _ \ 
  ...
  |_|    \___/
    ...
    try:
        menu = (input(Fore.LIGHTMAGENTA_EX + " 1- SMS Gönder Normal (Tavsiye etmem)\n\n 2- SMS Gönder Turbo (Taciz mode)\n\n 3- Çıkış\n\n" + Fore.LIGHTYELLOW_EX + " Seçim: "))
        if menu == "":
            continue
        menu = int(menu) 
    except ValueError:
